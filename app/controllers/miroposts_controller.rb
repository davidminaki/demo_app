class MiropostsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @miropost.save
        ...
        format.json { render :show, status: :created, location: @miropost }
      else
  ...
  def update
    respond_to do |format|
      if @miropost.update(miropost_params)
        ...
        format.json { render :show, status: :ok, location: @miropost }
      else
  ...
  private
    ...
    def miropost_params
      params.require(:miropost).permit(:content, :user_id, :integer)
    end
end
