...
class MiropostsControllerTest < ActionController::TestCase
  ...
  test "should create miropost" do
    assert_difference('Miropost.count') do
      post :create, miropost: { content: @miropost.content, integer: @miropost.integer, user_id: @miropost.user_id }
    end
  ...
  test "should update miropost" do
    patch :update, id: @miropost, miropost: { content: @miropost.content, integer: @miropost.integer, user_id: @miropost.user_id }
    assert_redirected_to miropost_path(assigns(:miropost))
  end
